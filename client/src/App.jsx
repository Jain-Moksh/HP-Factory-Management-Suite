...
const TotalPaymentReceivedReport = lazy(() => import('./pages/reports/TotalPaymentReceivedReport'));
const TotalPaymentReceivedDetail = lazy(() => import('./pages/reports/TotalPaymentReceivedDetail'));
    ...
    <BrowserRouter>
      <Suspense fallback={<PageLoader />}>
        <AuthGuard>
          ...
          <Route path="/reports/total-payment-received" element={<TotalPaymentReceivedReport />} />
          <Route path="/reports/total-payment-received/:partyType/:partyId" element={<TotalPaymentReceivedDetail />} />
