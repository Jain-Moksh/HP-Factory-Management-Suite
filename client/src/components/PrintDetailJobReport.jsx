        ...
        <table className="report-table">
          <thead>
            <tr style={{ borderBottom: '2px solid #000' }}>
              <th className="col-jobber" style={{ textAlign: 'left', padding: '4px 0' }}>JOBBER NAME</th>
              <th className="col-item" style={{ textAlign: 'left', padding: '4px 0' }}>ITEM NAME</th>
              <th className="col-qty text-right" style={{ padding: '4px 0' }}>TOTAL QTY</th>
            </tr>
          </thead>
          <tbody>
            {data.length > 0 ? (
              data.map((row, index) => {
                ...
                return (
                  <tr key={index}>
                    <td className="col-jobber" style={{ textTransform: 'uppercase', padding: '3px 0' }}>
                      {showJobberName ? row.jobber_name : ''}
                    </td>
                    <td className="col-item" style={{ textTransform: 'uppercase', padding: '3px 0' }}>
                      {row.item_name}
                    </td>
                    <td className="col-qty font-bold text-right" style={{ padding: '3px 0' }}>
