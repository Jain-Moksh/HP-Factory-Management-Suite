...
const PrintGroupPartySalesSummary = ({ data, groupName, startDate, endDate, paperSize = 'A4' }) => {
    ...
    <div className="print-container">
      ...
      <div className="print-report-container">
        ...
        <div className="report-header">
          <div className="report-title">Group Party Wise Sales Summary</div>
...
export default PrintGroupPartySalesSummary;
