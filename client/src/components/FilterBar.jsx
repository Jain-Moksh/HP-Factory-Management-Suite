...
const FilterBar = ({ 
  ...
  return (
    <div className="bg-white border border-border-soft rounded-xl px-4 py-2 shadow-sm mb-4 w-full flex items-center gap-4">
      <div className="flex items-center gap-2 shrink-0 border-r border-border-soft pr-4">
        ...
        <span className="text-[11px] font-bold text-text-primary uppercase tracking-tight whitespace-nowrap">Quick Filters</span>
      </div>
