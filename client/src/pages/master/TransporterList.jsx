        ...
        <div className="px-6 flex flex-col gap-6">
          ...
          <div className="bg-white border border-border-soft rounded-xl shadow-sm overflow-hidden">
            ...
            <div className="px-4 py-2.5 bg-bg-main/30 flex justify-end gap-16 border-t border-border-soft">
              <button 
                onClick={handleRedo}
                className="flex items-center gap-1.5 px-4 py-1.5 text-[11.5px] font-bold text-text-secondary hover:text-text-primary transition uppercase tracking-tight border border-brand-navy rounded-lg"
              >
