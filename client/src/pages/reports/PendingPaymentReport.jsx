    ...
    <Layout>
      <div className="flex flex-col min-h-screen relative pb-16">
        <PageHeader 
          ...
          subtitle="VIEW OUTSTANDING CLIENT BALANCES AND PENDING SETTLEMENTS" 
          actions={actions}
        ...
        <div className="px-6 flex flex-col gap-4 w-full">
                          ...
                          <tr>
                           ...
                           <tr>
                              <td colSpan="2" className="px-6 py-12 text-center italic text-text-light text-[12px] opacity-60">
                                 No pending payments found matching the current client or group selections.
                              </td>
                           </tr>
                        )}
                    </tbody>
          ...
          <div className="bg-bg-main/30 border border-border-soft rounded-lg p-3 flex items-start gap-3">
            ...
            <p className="text-[11px] text-text-light leading-snug font-medium italic">
              This report displays all clients that currently have positive pending outstanding balances, computed in real-time as: 
              <span className="font-bold"> Opening Balance + Total Billing - Total Payments - Total Replaces - Total Discounts</span>. 
              Clicking any row navigates directly to the party's billing details screen.
            </p>
          </div>
        </div>
      </div>
