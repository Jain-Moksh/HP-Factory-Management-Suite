                      ...
                      <tr key={row.id} className="hover:bg-bg-main/30 transition-colors duration-75">
                        ...
                        <td className="px-5 py-1.5 text-center border-r border-border-soft">
                          <span className={`px-2 py-0.5 rounded text-[9px] tracking-wider font-extrabold uppercase ${
                            ...
                            row.transaction_type === 'BILLING' ? 'bg-blue-50 text-blue-700 border border-blue-200' :
                            row.transaction_type === 'PAYMENT' ? 'bg-emerald-50 text-emerald-700 border border-emerald-200' :
                            row.transaction_type === 'REPLACE' ? 'bg-amber-50 text-amber-700 border border-amber-200' :
                            row.transaction_type === 'DISCOUNT' ? 'bg-indigo-50 text-indigo-700 border border-indigo-200' :
                        ...
                        <td className="px-5 py-1.5 text-right text-[13.5px] font-black text-blue-600 border-r border-border-soft">
                ...
                {data && data.ledger.length > 0 && (
                  <tfoot>
                    <tr className="bg-bg-main/50 border-t-2 border-border-soft">
                      ...
                      <td className="px-5 py-3 text-right text-[14px] font-black text-blue-600 border-r border-border-soft">
