...
import PrintItemSoldSummary from '../../components/PrintItemSoldSummary';
import { API_BASE_URL } from '../../config';

const ItemSoldSummary = () => {
    ...
    <Layout>
      <div className="flex flex-col min-h-screen relative pb-24">
        <PageHeader 
          ...
          subtitle="AGGREGATED SALES QUANTITIES BY ITEM FOR THE SELECTED PERIOD" 
                ...
                <table className="w-full border-collapse">
                    <thead>
                      <tr className="bg-table-header text-white">
                        ...
                        <th className="px-5 py-2 text-right text-[10.5px] uppercase font-bold tracking-wider px-10">Total Quantity Sold</th>
                      </tr>
                    </thead>
                          ...
                          <tr>
                            <td colSpan="2" className="px-6 py-20 text-center">
                                <div className="flex flex-col items-center gap-3">
                                  ...
                                  <span className="text-[13px] font-medium text-text-light">Aggregating sales records...</span>
                                </div>
                            </td>
                          </tr>
                        ) : data.length > 0 ? (
                           data.map((row, idx) => (
                             ...
                             >
                                <td className="px-5 py-2 text-[13px] font-bold text-text-primary border-r border-border-soft uppercase tracking-tight">
                                   {row.item_name}
                                </td>
                                <td className="px-5 py-2 text-right text-[14px] font-black text-brand-blue px-10">
...
export default ItemSoldSummary;
